...
public class AbstractDao<T> {
	...
	public List<T> findAll(Class<T> clazz, boolean existIsActive, Integer pageNumber, Integer pageSize){
		String entityName = clazz.getSimpleName();
		StringBuilder sql = new StringBuilder();
		sql.append("SELECT o FROM ").append(entityName).append(" o");
		if(existIsActive == true) {
	...
	public T findOne(Class<T> clazz, String sql, Object ... params) {
		try {
			...
			System.out.println("Cannot find entity to DB because "+e.getMessage());
			return null;
	...
	public T create(T entity) {
		try {
			...
			System.out.println("Cannot insert entity "+ entity.getClass().getSimpleName()+" to DB because "+e.getMessage());
