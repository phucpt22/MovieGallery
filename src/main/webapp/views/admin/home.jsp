		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item"><a href="<c:url value='admin'/>" class="nav-link active"> <i
								class="nav-icon fas fa-tachometer-alt"></i>
								<p>
									Home <i class="right fas fa-angle-left"></i>
								</p>
						</a></li>
						<li class="nav-item menu-open"><a href="<c:url value='admin/video?action=view'/>" class="nav-link">
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									<div class="card-header">
										<h3 class="card-title">Thống kê số người like</h3>
									</div>
									<div class="form-group">
										<label>Danh sách video:</label> <select id="selectVideo"
											class="form-control">
