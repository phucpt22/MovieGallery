...
public class TestHistory {
	public WebDriver driver;
	  ...
	  @Test(description = "Opens the TestNG Demo Website for History Test",priority = 1)
	  ...
	  @Test(description = "Fill the Regiser Details",priority = 2)
	  ...
	  @Test(description = "Opens the TestNG Demo Website for History Test",priority = 4)
	  ...
	  @Test(description = "Opens the TestNG Demo Website for History Test",priority = 6)
	  public void LaunchWebsite3() throws Exception{
		  try {
			driver.get("http://localhost:8080/AsmJava4/index");
			driver.manage().window().maximize();
			TestNGResults.put("2", new Object[] {1d,"Navigate to demo website", "Site gets opened","Pass"});			
		} catch (Exception e) {
			TestNGResults.put("2", new Object[] {1d,"Navigate to demo website", "Site gets opened","Fail"});
	  ...
	  @Test(description = "Opens the TestNG Demo Website for History Test",priority = 7)
	  public void LaunchWebsiteHistory() throws Exception{
		  try {
			driver.get("http://localhost:8080/AsmJava4/history");
			driver.manage().window().maximize();
			Thread.sleep(3000);
			TestNGResults.put("2", new Object[] {1d,"Navigate to demo website", "Site gets opened","Pass"});
		} catch (Exception e) {
	  ...
	  public void suiteTearDown() {
		  ...
		  try {
			FileOutputStream out = new FileOutputStream(new File("HistoryTest.xls"));
			workbook.write(out);
			out.close();
